...
%   X : m-length array of values  (x-axis = number of columns)
%   Y : n-length array of values  (y-axis = number of rows)
...
% 04/10/2022: fix vector handling
%
% Mark Humphries
...
% if vectors are columns, then rotate to row
